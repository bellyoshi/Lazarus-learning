...
type
  ...
  procedure FPDF_InitLibraryWithConfig(config: PFPDF_LIBRARY_CONFIG); cdecl; external PDFiumDll name 'FPDF_InitLibraryWithConfig';
  procedure FPDF_InitLibraryWithConfig(config: PFPDF_LIBRARY_CONFIG); cdecl; external PDFiumDll name 'FPDF_InitLibraryWithConfig';
  procedure FPDF_DestroyLibrary(); cdecl; external PDFiumDll name 'FPDF_DestroyLibrary';

const
  FPDF_POLICY_MACHINETIME_ACCESS = 0;
  function FPDF_LoadDocument(file_path: FPDF_STRING; password: FPDF_BYTESTRING): FPDF_DOCUMENT; cdecl; external PDFiumDll name 'FPDF_LoadDocument';
...
type
  ...
  FPDF_FILEACCESS = record
    ...
    function m_GetBlock: function(param: Pointer; position: LongWord; pBuf: PByte; size: LongWord): Integer; cdecl; external PDFiumDll name 'm_GetBlock';
